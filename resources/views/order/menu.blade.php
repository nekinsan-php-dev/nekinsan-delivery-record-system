<div class="bg-white rounded-lg shadow-lg p-6 space-y-6">
    ...
    <form id="orderFilterForm" class="space-y-4" method="POST">
        ...
        <div class="flex justify-between items-center">
            ...
            <button type="submit" formaction="{{ url('/orders/export') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                <svg class="-ml-1 mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
